...
<body>
  ...
  <div class="humberger__menu__wrapper">
    ...
    <div class="humberger__menu__contact">
      <ul>
        <li><i class="fa fa-instagram"></i> dapur_uti20</li>
          ...
          <div class="hero__search">
            ...
            <div class="hero__search__phone">
              ...
              <div class="hero__search__phone__text">
                <a href="https://wa.link/nuvl36" target="_blank"><h4>081360411795</h4></a>
                <span>buka 7/24 jam</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 col-sm-6">
          <div class="footer__about">
            ...
            <ul>
              <li>Alamat  : Sidoreno - Kencong</li>
              <li>No. Hub : 085790549649 <br> <a href="https://wa.link/nuvl36" target="_blank">081360411795</a></li>
        ...
        <div class="col-lg-4 col-md-12">
          <div class="footer__widget">
            ...
            <div class="footer__widget__social">
              <!-- <a href="#"><i class="fa fa-facebook"></i></a> -->
              <a href="https://www.instagram.com/dapur_uti20"><i class="fa fa-instagram"></i></a>
              <!-- <a href="#"><i class="fa fa-twitter"></i></a> -->
