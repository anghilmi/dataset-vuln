...
<head>
  ...
  <link href="landing-page/css/variables.css" rel="stylesheet">
  <!-- <link href="landing-page/css/variables-blue.css" rel="stylesheet"> -->
  <!-- <link href="landing-page/css/variables-green.css" rel="stylesheet"> -->
  <!-- <link href="landing-page/css/variables-orange.css" rel="stylesheet"> -->
  <!-- <link href="landing-page/css/variables-purple.css" rel="stylesheet"> -->
  <!-- <link href="landing-page/css/variables-red.css" rel="stylesheet"> -->
  <!-- <link href="landing-page/css/variables-pink.css" rel="stylesheet"> -->
...
<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top" data-scrollto-offset="0" style="background-color: lightgray">
      ...
      <div class="container" data-aos="zoom-out">
        ...
        <div class="row g-5">
          ...
          <div class="col-lg-4 col-md-6 order-first order-md-last d-flex align-items-center">
            <div class="img">
              <img src="landing-page/img/cta.jpg" alt="" class="img-fluid">
            </div>
          </div>
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active show" id="tab-1">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center" data-aos="fade-up" data-aos-delay="200">
                <img src="landing-page/img/features-1.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-2">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="landing-page/img/features-2.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-3">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="landing-page/img/features-3.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-4">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="landing-page/img/features-4.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-5">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="landing-page/img/features-5.svg" alt="" class="img-fluid">
              </div>
            </div>
          ...
          <div class="tab-pane" id="tab-6">
            <div class="row gy-4">
              ...
              <div class="col-lg-4 order-1 order-lg-2 text-center">
                <img src="landing-page/img/features-6.svg" alt="" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row gy-5">
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="200">
            <div class="service-item">
              <div class="img">
                <img src="landing-page/img/programming.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                ...
                <a href="#" class="stretched-link">
                  <h3>Pemrograman Aplikasi Dasar</h3>
                </a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="300">
            <div class="service-item">
              <div class="img">
                <img src="landing-page/img/services-6.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                ...
                <a href="#" class="stretched-link">
                  <h3>Menggambar Menggunakan CAD 3D</h3>
                </a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="400">
            <div class="service-item">
              <div class="img">
                <img src="landing-page/img/network.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                  <i class="bi bi-easel"></i>
                </div>
                <a href="/jarkom" class="stretched-link">
          ...
          <div class="col-xl-4 col-md-6" data-aos="zoom-in" data-aos-delay="500">
            <div class="service-item">
              <div class="img">
                <img src="landing-page/img/services-4.jpg" class="img-fluid" alt="">
              </div>
              <div class="details position-relative">
                <div class="icon">
                ...
                <a href="#" class="stretched-link">
                  <h3>OPERASI PENGELASAN DASAR</h3>
                </a>
    ...
    {{-- <section id="faq" class="faq">
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style='background-image: url("landing-page/img/faq.jpg");'>&nbsp;</div>
        </div>
