...
class ProfilDokterController extends Controller
{
    public function index()
    {
        ...
        return view("dokter.profil.index", $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect("/dokter/profil")->with('success','Akun anda telah diperbarui');
    }
    public function change_password(Request $request, $id){
        ...
        return redirect("/dokter/profil")->with('success','Password updated successfully');
    }
