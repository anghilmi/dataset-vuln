    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card" style="margin-top: 20px;">
                <form action="{{ url('/admin/users/dokter') }}" method="POST" enctype="multipart/form-data" id="formulir-dokter-data">
                    @csrf
