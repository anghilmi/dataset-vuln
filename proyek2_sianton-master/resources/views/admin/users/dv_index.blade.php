...
@section("title_content", "Data Dokter")
        ...
        <div class="col-lg-12">
            ...
            <div class="card" style="margin-top: 20px;">
                <div class="card-header">
                    <a href="{{url("/admin/users/dokter/create")}}" class="btn btn-primary float-end">
                        Tambah Data
                    </a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped"  style="margin-top: 16px;" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td ><img src="{{ url('/storage/'. $u->gambar) }}" height="40"></td>
                                <td>{{ $u->nama }}</td>
                                <td>{{ $u->email }}</td>
                                <td class="text-center">
                                    {{-- <a href="{{url("/admin/users/dokter/" . $u->id . '/edit' )}}" class="btn btn-warning btn-sm">
                                        Edit
                                    </a> --}}
                                    <form action="{{ url('/admin/users/dokter/'.$u->id) }}" method="POST" style="display: inline">
                                        @method("DELETE")
                                        @csrf
